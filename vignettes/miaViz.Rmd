...
In the next example the ~SampleType~ is plotted along the samples. In this case, the result is a single plot that includes abundance
and sample plots. 
...
```{r}
plot <- plotAbundance(GlobalPatterns, abund_values = "counts", rank = "Phylum",
                        features = "SampleType")
...
More examples and materials are available at Orchestrating Microbiome 
Analysis [@OMA].


# Plotting options

See `help("mia-plot-args")` for more options for adjusting the plots.
