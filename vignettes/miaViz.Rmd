...
```{r, eval=FALSE}
# miaTime is not in Bioc or CRAN. Package needs to be there if it is utilized
# in vignette. That is why miaTime-related chunks are eval=FALSE. Remove these
# when miaTime is in Bioc.
