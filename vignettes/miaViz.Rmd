...
`other.fields` argument. Note that currently information for nodes have to be
provided via the `other.fields` arguments.
...
Tip and node labels can be shown as well. Setting `show.label = TRUE` shows the
tip labels only ...
