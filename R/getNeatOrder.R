...
#' 
#' @details 
#' It's important to note that the [\pkg{sechm}](https://bioconductor.org/packages/3.18/bioc/vignettes/sechm/inst/doc/sechm.html#row-ordering) package does actually have the functionality 
#' for plotting a heatmap using this radial theta angle ordering, though only by using an 
#' MDS ordination. 
#'   
...
#' res <- calculatePCA(tse, assay.type = "standardized", ncomponents = 10)
#' 
